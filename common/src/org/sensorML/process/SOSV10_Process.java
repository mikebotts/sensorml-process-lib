...
import org.vast.ows.sos.SOSResponseReaderV10;
 ...
 * @version 1.0
 */
public class SOSV10_Process extends DataProcess implements DataHandler
{
                ...
                public void run()
                {
                    ...
                    {    
                        synchronized (handler)
                        {
                            ...
                            // create reader
                            SOSResponseReaderV10 reader = new SOSResponseReaderV10();
