 ...
 * @version 1.0
 */
public class TLEParser2_Process extends DataProcess
{
    // input time
    ...
    // internal variables
    protected String tleFileName, tlePath, tleDirPath;
    ...
    public TLEParser2_Process()
    {
        reset();
    }
    
    
    public TLEParser2_Process(String tlePath)
    {
        this();
